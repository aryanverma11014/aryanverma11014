...
| [House Prediction](https://house-predic-pmveenxvhq77kh5cqp5zdp.streamlit.app/) | ML project that predicts House price on various combined featues. | Python, Scikit-learn, Pandas, NumPy
Streamlit (Web UI)
Gradient Boosting Regressor| Live |
